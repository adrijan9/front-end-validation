...
function DateFormats (formatType) {
    if (IsDate(formatType)) {
        return moment__default['default'](formatType);
    }
    var date = null;
    switch (formatType) {
        case 'yesterday':
            date = moment__default['default']().subtract(1, "day");
            break;
        case 'tomorrow':
            date = moment__default['default']().add(1, "day");
            break;
        case 'today':
            date = moment__default['default']();
            break;
    }
    return date;
}
...
exports.ArrayHasItems = ArrayHasItems;
exports.Clone = Clone;
exports.DateFormats = DateFormats;
exports.GetDuplicatesFromArray = GetDuplicatesFromArray;
